...
public class RoomAssignmentServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            // Query to get room assignments and their status
            String sql = "SELECT room_number, room_type, status, patient_name, assignment_date, end_date, assigned_days " +
        ...
        try {
            ...
            if (patientId != null && patientName != null && assignedDays != null) {
                ...
                if (rs.next()) {
                    ...
                    String insertSql = "UPDATE room_assignments SET patient_id = ?, patient_name = ?, status = 'Occupied', " +
